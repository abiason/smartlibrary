...
SRC := src/main.c src/config/config.c src/database/postgres.c src/database/mongodb.c src/repositories/cadastro_repository.c src/services/cadastro_service.c src/ui/cadastro_ui.c src/utils/input.c src/models/usuario.c src/models/autor.c src/models/editora.c src/models/genero.c src/models/livro.c src/models/exemplar.c src/models/emprestimo.c src/models/reserva.c
